...
/**
 * ***************************************************************** *
 * content of pgconfig and hbaconfig  path to data directory panel *
 * ***************************************************************** *
 */
trait StepTwoAbstractConfig extends IConfigTabContent {
  ...
  /* File browsing */
  protected lazy val configFilesPanel = new StepTwoPgDataDirPanel(_updateWorkingFile)
  ...
  protected def onCancelWorkingFilesPressed(): Unit = {
    ...
    configFilesPanel.setPgDataDir(QuickStart.postgresqlDataDir)
  }
  /* Private methods */
