...
/**
 * Creates and displays sequence repository postgreSQL panel.
 * @author aromdhani
 *
 */

class SeqReposPgPanel(model: SeqReposModelView) extends VBox {

  // Load initial configurations
  private val dbConfigOpt = model.seqReposConfigOpt()
  require(dbConfigOpt.isDefined, "Sequence repository configuration must not be null nor empty!")
