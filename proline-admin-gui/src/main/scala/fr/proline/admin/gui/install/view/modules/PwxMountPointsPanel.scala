...
/**
 * Creates and displays PWX mount points panel.
 * @author aromdhani
 *
 */
class PwxMountPointsPanel(model: PwxModelView) extends CustomScrollPane with LazyLogging {

  /* Configuration files */
//  private val serverConfigOpt = model.pwxConfigFileOpt().map(_.read()).flatten
//  /*
//   * ********** *
//   * COMPONENTS *
//   * ********** *
...
//  }
//
//  /** Return Proline mount points as ServerConfig */
...
//    else {
//      mountPointsBuilder.append("Mount Points:\n\t")
